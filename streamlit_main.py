...
def main():
    ...
    if menu_choice == "Read Movies":
        ...
        year = st.number_input("Enter the year of release", min_value=1900, max_value=2100)
        ...
        new_year = st.number_input("Enter the new year of release", min_value=1900, max_value=2100)
